...
console.log(creature1.weight);

// What was the diet of a velociraptor?
console.log(creature3.diet);

// How long was a stegosaurus?
console.log(creature2.length);

// What time period did tyrannosaurus live in?
console.log(creature1.period);
...
*/
const populationTotal = zooAnimals.reduce((totalAnimals, zoo) => {
  return totalAnimals + zoo.population;
}, 0);
